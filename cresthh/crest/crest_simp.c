...
#define __PYX_HAVE__crest_simp
#define __PYX_HAVE_API__crest_simp
/* Early includes */
#ifdef _OPENMP
#include <omp.h>
#endif /* _OPENMP */
...
static const char __pyx_k_Wmaxm[] = "Wmaxm";
...
static const char __pyx_k_overland[] = "overland";
static const char __pyx_k_precipIn[] = "precipIn";
...
static PyObject *__pyx_n_s_Ksat;
...
static int __pyx_f_10crest_simp_checkWaterBalance(double __pyx_v_P, double __pyx_v_ET, double __pyx_v_SW, double __pyx_v_overland, double __pyx_v_interflow) {
  double __pyx_v_balanced;
  int __pyx_r;
...
/* Python wrapper */
static PyObject *__pyx_pw_10crest_simp_1model(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
...
static PyObject *__pyx_pw_10crest_simp_1model(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("model (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        case  0:
        if (likely((values[0] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_precipIn)) != 0)) kw_args--;
 ...
 *             R= precipSoil
 */
        __pyx_v_Wo = (__pyx_v_SM + __pyx_v_infiltration);
      }
      __pyx_L12:;
 ...
 */
    /*else*/ {
      __pyx_v_interflow = __pyx_v_temX;
    }
    __pyx_L16:;
 ...
 *     SM= Wo
 */
    __pyx_v_actET = (__pyx_v_ExcessET + __pyx_v_precip);
  }
  __pyx_L8:;
...
static int __pyx_pymod_exec_crest_simp(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_crest_simp},
  {0, NULL}
};
#endif
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_Ksat, __pyx_k_Ksat, sizeof(__pyx_k_Ksat), 0, 0, 1, 1},
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initcrest_simp(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initcrest_simp(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_crest_simp(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_crest_simp(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_crest_simp(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'crest_simp' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_crest_simp(void)", 0);
  ...
  #endif
  if (__pyx_module_is_main_crest_simp) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "crest_simp")) {
      if (unlikely(PyDict_SetItemString(modules, "crest_simp", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init crest_simp", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init crest_simp");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
